function Sanskrit(textarea, options){
  ...
  for (var callback in Sanskrit.prototype.callbacks) {
    if (typeof this.options[callback] == 'function') {
      ...
      this.callbacks[callback] = Sanskrit.prototype.callbacks[callback];
    }
  }
...
function SanskritToolbar(editor, options) {
  ...
  for (var action in this.actions) {
    ...
    } else if (typeof SanskritToolbar.prototype.callbacks[callbackName] == 'function') {
      this.callbacks[callbackName] = SanskritToolbar.prototype.callbacks[callbackName];
    }
  }
